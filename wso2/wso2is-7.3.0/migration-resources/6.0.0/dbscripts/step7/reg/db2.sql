...
CALL ADD_PRIMARY_KEY_COLUMN('REG_RESOURCE_COMMENT')
/

CALL ADD_PRIMARY_KEY_COLUMN('REG_RESOURCE_RATING')
/

CALL ADD_PRIMARY_KEY_COLUMN('REG_RESOURCE_TAG')
/

CALL ADD_PRIMARY_KEY_COLUMN('REG_RESOURCE_PROPERTY')
/
