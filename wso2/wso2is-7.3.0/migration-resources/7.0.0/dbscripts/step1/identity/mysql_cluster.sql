...
ALTER TABLE IDN_OAUTH2_AUTHZ_CODE_SCOPE MODIFY SCOPE VARCHAR(255);
...
ALTER TABLE IDN_SCIM_GROUP
	ADD COLUMN AUDIENCE_REF_ID INTEGER DEFAULT -1 NOT NULL,
	DROP INDEX ROLE_NAME,
	ADD CONSTRAINT AUDIENCE_REF_ID UNIQUE(TENANT_ID, ROLE_NAME, ATTR_NAME, AUDIENCE_REF_ID);
