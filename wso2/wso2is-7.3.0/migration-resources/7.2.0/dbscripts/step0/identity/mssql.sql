...
IF NOT EXISTS (SELECT * FROM MIGRATION_STATUS WHERE IS_VERSION = '7.2.0')
BEGIN
    INSERT INTO MIGRATION_STATUS (IS_VERSION, LOCKED_BY, STATUS, LOCK_ACQUIRED_AT, EXPIRES_AT)
    VALUES ('7.2.0', NULL, 'NOT-STARTED', NULL, NULL)
END;

IF NOT EXISTS (SELECT * FROM MIGRATOR_PROGRESS WHERE IS_VERSION = '7.2.0')
BEGIN
    ...
    VALUES ('7.2.0', 'NOT-STARTED', NULL, NULL, NULL, NULL)
END;
