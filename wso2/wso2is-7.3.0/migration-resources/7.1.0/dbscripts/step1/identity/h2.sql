...
ALTER TABLE IF EXISTS IDP_AUTHENTICATOR ADD COLUMN IF NOT EXISTS DEFINED_BY VARCHAR(25) NOT NULL DEFAULT 'SYSTEM';

-- Add AUTHENTICATION_TYPE column to IDP_AUTHENTICATOR
ALTER TABLE IF EXISTS IDP_AUTHENTICATOR ADD COLUMN IF NOT EXISTS AUTHENTICATION_TYPE VARCHAR(25) NOT NULL DEFAULT 'IDENTIFICATION';

-- Add IMAGE_URL column to IDP_AUTHENTICATOR
ALTER TABLE IF EXISTS IDP_AUTHENTICATOR ADD COLUMN IF NOT EXISTS IMAGE_URL VARCHAR(1024);

-- Add DESCRIPTION column to IDP_AUTHENTICATOR
ALTER TABLE IF EXISTS IDP_AUTHENTICATOR ADD COLUMN IF NOT EXISTS DESCRIPTION VARCHAR(1024);

-- Add VERSION column to SP_APP
ALTER TABLE IF EXISTS SP_APP ADD COLUMN IF NOT EXISTS VERSION VARCHAR(255) NOT NULL DEFAULT 'v1.0.0';

-- Add UUID column to IDN_CERTIFICATE
ALTER TABLE IF EXISTS IDN_CERTIFICATE ADD COLUMN IF NOT EXISTS UUID CHAR(36);

-- Add TOKEN_BINDING_REF column to IDN_OAUTH2_ACCESS_TOKEN_AUDIT
ALTER TABLE IF EXISTS IDN_OAUTH2_ACCESS_TOKEN_AUDIT ADD COLUMN IF NOT EXISTS TOKEN_BINDING_REF VARCHAR(32) DEFAULT 'NONE';

-- Add CONSENTED_TOKEN column to IDN_OAUTH2_ACCESS_TOKEN_AUDIT
ALTER TABLE IF EXISTS IDN_OAUTH2_ACCESS_TOKEN_AUDIT ADD COLUMN IF NOT EXISTS CONSENTED_TOKEN VARCHAR(6);

-- Add AUTHORIZED_ORGANIZATION column to IDN_OAUTH2_ACCESS_TOKEN_AUDIT
ALTER TABLE IF EXISTS IDN_OAUTH2_ACCESS_TOKEN_AUDIT ADD COLUMN IF NOT EXISTS AUTHORIZED_ORGANIZATION VARCHAR(36) NOT NULL DEFAULT 'NONE';
