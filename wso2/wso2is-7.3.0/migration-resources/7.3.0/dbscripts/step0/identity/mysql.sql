...
SELECT '7.3.0', NULL, 'NOT-STARTED', NULL, NULL
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM MIGRATION_STATUS WHERE IS_VERSION = '7.3.0');
...
SELECT '7.3.0', 'NOT-STARTED', NULL, NULL, NULL, NULL
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM MIGRATOR_PROGRESS WHERE IS_VERSION = '7.3.0');
