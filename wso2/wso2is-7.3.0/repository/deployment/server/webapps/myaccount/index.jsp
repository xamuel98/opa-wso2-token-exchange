...
<html>
    <head>
        ...
        <script type="text/javascript" src="/myaccount/update.config.js"></script>
        <script type="text/javascript" src="/myaccount/config.js"></script>
        ...
        <script src="/myaccount/startup-config.js"></script>
        <script>
            var userAccessedPath = window.location.href;
        ...
        <script>
            ...
            var authSessionState = "<%=Encode.forHtml(request.getParameter("session_state"))%>" != "null"
                ...
                : null;
            var authIdPs = "<%=Encode.forHtml(request.getParameter("AuthenticatedIdPs"))%>" != "null"
                ? "<%=Encode.forHtml(request.getParameter("AuthenticatedIdPs"))%>"
                : null;
        </script>
        ...
        <script
            ...
            src="/myaccount/extensions/head-script.js"
    ...
    <script>
        ...
        var isSuperTenantRequiredInUrl = "<%=isSuperTenantRequiredInUrl()%>";
        ...
        function authenticateWithSDK() {
            ...
            if(!authorizationCode) {
                ...
                function resolveClientId() {
                    var enableTenantQualifiedUrls = <%=isTenantQualifiedUrlsEnabled()%>;
                    var defaultClientId = "MY_ACCOUNT";
