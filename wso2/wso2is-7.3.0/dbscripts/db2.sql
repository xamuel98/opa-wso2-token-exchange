...
CREATE UNIQUE INDEX UM_SYSTEM_USER_UM_LOWER_USER_NAME_UM_TENANT_ID ON UM_SYSTEM_USER(LOWER(UM_USER_NAME), UM_TENANT_ID)/
...
CREATE UNIQUE INDEX UM_USER_PERMISSION_UM_PERMISSION_ID_LOWER_UM_USER_NAME_UM_TENANT_ID ON UM_USER_PERMISSION(UM_PERMISSION_ID, LOWER(UM_USER_NAME), UM_TENANT_ID)/
...
CREATE UNIQUE INDEX UM_ACCOUNT_MAPPING_UM_USER_NAME_UM_TENANT_ID_UM_USER_STORE_DOMAIN_UM_ACC_LINK_ID ON UM_ACCOUNT_MAPPING(LOWER(UM_USER_NAME), UM_TENANT_ID, UM_USER_STORE_DOMAIN, UM_ACC_LINK_ID)/
...
CREATE UNIQUE INDEX UM_HYBRID_USER_ROLE_LOWER_UM_USER_NAME_UM_ROLE_ID_UM_TENANT_ID ON UM_HYBRID_USER_ROLE(LOWER(UM_USER_NAME), UM_ROLE_ID, UM_TENANT_ID)/
...
CREATE TABLE UM_HYBRID_USER_ROLE_RESTRICTED_EDIT_PERMISSIONS (
    UM_ID DECIMAL(31,0) NOT NULL,
    UM_HYBRID_USER_ROLE_ID DECIMAL(31,0) NOT NULL,
    UM_HYBRID_USER_ROLE_TENANT_ID DECIMAL(31,0) NOT NULL,
...
CREATE SEQUENCE UM_HYBRID_USER_ROLE_RESTRICTED_EDIT_PERMISSIONS_SEQ AS DECIMAL(27,0)
    INCREMENT BY 1
    START WITH 1
    NO CACHE/

CREATE TRIGGER UM_HYBRID_USER_ROLE_RESTRICTED_EDIT_PERMISSIONS_TRG
...
SELECT '10084a8d-113f-4211-a0d5-efe36b082211', 'Super', 'This is the super organization.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'ACTIVE', 'TENANT', 'v1.0.0' FROM "SYSIBM".SYSDUMMY1
...
CREATE SEQUENCE UM_ORG_USER_ASSOCIATION_SEQ AS DECIMAL(27,0)
    INCREMENT BY 1
    START WITH 1
    NO CACHE/

CREATE TRIGGER UM_ORG_USER_ASSOCIATION_TRG
    NO CASCADE BEFORE INSERT
