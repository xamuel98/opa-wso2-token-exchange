...
IF EXISTS (SELECT NAME FROM SYSINDEXES WHERE NAME = 'REG_RESC_PROP_BY_PROP_ID_TI')
DROP INDEX REG_RESOURCE_PROPERTY.REG_RESC_PROP_BY_PROP_ID_TI
...
IF EXISTS (SELECT NAME FROM SYSINDEXES WHERE NAME = 'INDEX_ROLE_PERMSN_TI_RN')
DROP INDEX UM_ROLE_PERMISSION.INDEX_ROLE_PERMSN_TI_RN
...
CREATE TRIGGER UM_ORG_DELETE_TRIGGER ON UM_ORG INSTEAD OF DELETE AS BEGIN DELETE FROM UM_ORG_DISCOVERY WHERE UM_ROOT_ORG_ID IN (SELECT UM_ID FROM deleted) DELETE FROM UM_ORG_DISCOVERY WHERE UM_ORG_ID IN (SELECT UM_ID FROM deleted) DELETE FROM UM_ORG_HIERARCHY WHERE UM_PARENT_ID IN (SELECT UM_ID FROM deleted) DELETE FROM UM_ORG_HIERARCHY WHERE UM_ID IN (SELECT UM_ID FROM deleted) DELETE FROM UM_RESOURCE_SHARING_POLICY WHERE UM_INITIATING_ORG_ID IN (SELECT UM_ID FROM deleted) DELETE FROM UM_RESOURCE_SHARING_POLICY WHERE UM_POLICY_HOLDING_ORG_ID IN (SELECT UM_ID FROM deleted) DELETE FROM UM_ORG WHERE UM_PARENT_ID IN (SELECT UM_ID FROM deleted) DELETE FROM UM_ORG WHERE UM_ID IN (SELECT UM_ID FROM deleted) END;
