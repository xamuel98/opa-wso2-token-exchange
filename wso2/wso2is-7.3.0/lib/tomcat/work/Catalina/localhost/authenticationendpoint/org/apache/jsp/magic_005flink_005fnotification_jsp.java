...
public final class magic_005flink_005fnotification_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 request.setAttribute("pageName", "magic-link-notification"); 
    ...
    layoutData.put("isSuccessResponse", true);
      ...
      try {
        ...
        // /magic_link_notification.jsp(61,4) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /magic_link_notification.jsp(61,4) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /magic_link_notification.jsp(61,4) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /magic_link_notification.jsp(62,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /magic_link_notification.jsp(72,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("                <h3 class=\"ui header text-center slogan-message mt-4 mb-6\" data-testid=\"password-recovery-notify-page-header\">\n");
                  out.write("                    ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "magic.link.heading" ));
                  out.write("\n");
                  out.write("                </h3>\n");
                  out.write("                <p class=\"portal-tagline-description\">\n");
                  out.write("                    <span id=\"sent-email\">\n");
                  out.write("                        ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "magic.link.content" ));
                  out.write("\n");
                  out.write("                    </span>\n");
                  out.write("                </p>\n");
                  out.write("\n");
 ...
 if (StringUtils.isNotBlank(supportEmail)) { 
                  out.write("\n");
                  out.write("                    <p class=\"ui portal-tagline-description\" data-testid=\"password-recovery-support-message\">\n");
                  out.write("                        ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "if.you.still.havent.received.please.write.to"));
                  out.write("\n");
                  out.write("                        <a href=\"mailto:");
                  out.print( StringEscapeUtils.escapeHtml4(supportEmail) );
                  out.write("\"\n");
                  out.write("                        data-testid=\"magic-link-resend-support-email\"\n");
            ...
            try {
              ...
              // /magic_link_notification.jsp(98,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("            if(sessionStorage.getItem(\"username\")){\n");
      out.write("                var username = sessionStorage.getItem(\"username\").split(\"@\");\n");
      out.write("                username[0] = username[0].split(\"\").map(function(letter, index) {\n");
      out.write("                    if (index === 0 || index === username[0].length - 1) {\n");
      out.write("                        return letter;\n");
      out.write("                    } else {\n");
      out.write("                        return \"*\";\n");
      out.write("                    }\n");
      out.write("                }).join(\"\");\n");
  ...
  private boolean _jspx_meth_layout_005fdynamicComponent_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_layout_005fmain_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /magic_link_notification.jsp(109,8) name = filePathStoringVariableName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
