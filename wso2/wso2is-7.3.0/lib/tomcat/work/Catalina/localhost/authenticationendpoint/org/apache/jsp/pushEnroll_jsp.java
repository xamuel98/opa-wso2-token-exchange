...
public final class pushEnroll_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    */
    ...
    if (authenticators.equals(LOCAL_PUSH_AUTHENTICATOR_ID)) {
        try {
            pushAppInfoLink = AuthenticatorUtils.getPushAuthenticatorConfig("PUSH.PushAppInfoLink", tenantDomain);
        } catch (Exception e) {
 ...
 request.setAttribute("pageName", "push-enroll"); 
      ...
      try {
        ...
        // /pushEnroll.jsp(106,8) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /pushEnroll.jsp(106,8) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /pushEnroll.jsp(106,8) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /pushEnroll.jsp(107,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /pushEnroll.jsp(119,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\n");
                  out.write("                <div class=\"ui segment attached segment-with-attached mt-3\">\n");
                  out.write("                    ");
                  out.write("\n");
                  out.write("                    <h3 class=\"ui header text-center\">\n");
                  out.write("                        ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "register.push.device"));
                  out.write("\n");
                  out.write("                    </h3>\n");
                  out.write("                    ");
                  ...
                  out.write("                        <form class=\"ui large form mb-0\" id=\"register_form\" name=\"register_form\" action=\"");
                  ...
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle,
                                        "scan.the.qr.code.using.push.authenticator.app"));
                  out.write("\n");
                  out.write("                            </p>\n");
                  out.write("\n");
                  ...
                  out.write("'/>\n");
                  out.write("                            <input type=\"hidden\" name=\"pushEnrollData\" id=\"pushEnrollData\"\n");
                  out.write("                                value='");
                  out.print(Encode.forHtmlAttribute(request.getParameter("pushEnrollData")));
                  out.write("'/>\n");
                  out.write("                            <input type='hidden' name='scenario' id='scenario' value=''/>\n");
                  out.write("\n");
                  out.write("                            <div class=\"ui center aligned basic segment middle aligned pl-3\">\n");
                  out.write("                                <form name=\"qrinp\">\n");
                  out.write("                                    <input type=\"numeric\" name=\"ECC\" value=\"1\" size=\"1\" style=\"Display:none\" id=\"ecc\">\n");
                  out.write("                                    <canvas id=\"qrcanv\">\n");
                  out.write("                                </form>\n");
                  out.write("                            </div>\n");
                  out.write("\n");
                  out.write("                            <div>\n");
                  ...
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle,
                                            "confirm.you.have.scanned.the.qr.code.push"));
                  out.write("</label>\n");
                  out.write("                                    </div>\n");
                  out.write("                                </div>\n");
                  out.write("                            </div>\n");
                  ...
                  out.write("                ");
                    ...
                    if (pushAppInfoLink != null) {
                
                  out.write("\n");
                  out.write("                <div class=\"ui warning bottom attached message text-left display-flex\" style=\"font-size: small;\">\n");
                  out.write("                    <i aria-hidden=\"true\" class=\"warning circle icon\"></i>\n");
                  out.write("                    <div class=\"message-content\">\n");
                  out.write("                        ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "dont.have.app.download"));
                  out.write("\n");
                  out.write("                        <a\n");
                  out.write("                            href=");
                  out.print(pushAppInfoLink);
                  out.write("\n");
                  out.write("                        >\n");
                  out.write("                            ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "dont.have.app.download.link"));
                  out.write("\n");
                  out.write("                        </a>\n");
                  out.write("                        ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "for.more.details.and.download.options"));
                  out.write("\n");
                  out.write("                    </div>\n");
                  out.write("                </div>\n");
                  out.write("                ");
            ...
            try {
              ...
              // /pushEnroll.jsp(216,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("            var registerForm = $(\"#register_form\");\n");
      out.write("\n");
      ...
      out.write("                    document.getElementById(\"scenario\").value = \"PUSH_DEVICE_ENROLLMENT\";\n");
      out.write("                    registerForm.submit();\n");
      out.write("                });\n");
      out.write("                showQR();\n");
      out.write("            });\n");
      out.write("\n");
      out.write("            function showQR(){\n");
      out.write("                var key =  document.getElementById(\"pushEnrollData\").value;\n");
  ...
  private boolean _jspx_meth_layout_005fdynamicComponent_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_layout_005fmain_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /pushEnroll.jsp(228,12) name = filePathStoringVariableName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
