...
public final class org_005fname_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 request.setAttribute("pageName", "org-name"); 
      ...
      try {
        ...
        // /org_name.jsp(88,8) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /org_name.jsp(88,8) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /org_name.jsp(88,8) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /org_name.jsp(89,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /org_name.jsp(104,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("\n");
                  out.write("\n");
                  out.write("                    <form class=\"ui large form\" id=\"pin_form\" name=\"pin_form\" action=\"");
                  out.print(commonauthURL);
                  out.write("\" method=\"GET\">\n");
                  out.write("                        <div class=\"field m-0 text-left required\">\n");
                  out.write("                            <label>");
                  out.print( i18n(resourceBundle, customText, "organization.name") );
                  out.write("</label>\n");
                  out.write("                        </div>\n");
                  out.write("                        <input type=\"text\" id='ORG_NAME' name=\"org\" size='30'/>\n");
                  out.write("                        <div class=\"mt-1\" id=\"emptyOrganizationNameError\" style=\"display: none;\">\n");
                  out.write("                            <i class=\"red exclamation circle fitted icon\"></i>\n");
                  out.write("                            <span class=\"validation-error-message\" id=\"emptyOrganizationNameErrorText\">\n");
                  out.write("                                ");
                  out.print( i18n(resourceBundle, customText, "organization.name.cannot.be.empty") );
                  out.write("\n");
                  out.write("                            </span>\n");
                  out.write("                        </div>\n");
                  out.write("                        <input id=\"prompt\" name=\"prompt\" type=\"hidden\" value=\"orgDiscovery\">\n");
                  out.write("                        ");
 if (StringUtils.isNotBlank(idp)) { 
                  ...
                  out.write("\"/>\n");
                  out.write("                        <div class=\"ui divider hidden\"></div>\n");
                  out.write("                        <input type=\"submit\" id=\"submitButton\" onclick=\"submitOrgName(); return false;\"\n");
                  out.write("                            value=\"");
 ...
 if (isOrgDiscoveryEnabled) { 
                  ...
                  out.write("                                <input type=\"submit\" id=\"discoveryButton\" onclick=\"promptDiscovery();\" class=\"ui primary basic button link-button\"\n");
                  out.write("                                    value=\"");
                  out.print( i18n(resourceBundle, customText, "provide.email.address"));
                  out.write("\">\n");
                  out.write("                            </div>\n");
                  out.write("                        ");
 } 
            ...
            try {
              ...
              // /org_name.jsp(162,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("            }\n");
      out.write("\n");
      out.write("            function promptDiscovery() {\n");
      out.write("                document.getElementById(\"ORG_NAME\").disabled = true;\n");
      out.write("                document.getElementById(\"pin_form\").submit();\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            function submitOrgName() {\n");
      out.write("                // Show error message when organization name is empty.\n");
      out.write("                if (document.getElementById(\"ORG_NAME\").value.length <= 0) {\n");
      out.write("                    showEmptyOrganizationNameErrorMessage();\n");
      out.write("                    return;\n");
      out.write("                }\n");
      out.write("\n");
      ...
      out.write("            }\n");
      out.write("\n");
      out.write("            // Function to show error message when organization name is empty.\n");
      out.write("            function showEmptyOrganizationNameErrorMessage() {\n");
      out.write("                var emptyOrganizationNameError = $(\"#emptyOrganizationNameError\");\n");
      out.write("                emptyOrganizationNameError.show();\n");
      out.write("            }\n");
      out.write("        </script>\n");
      out.write("    </body>\n");
      out.write("</html>\n");
  ...
  private boolean _jspx_meth_layout_005fdynamicComponent_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_layout_005fmain_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /org_name.jsp(177,12) name = filePathStoringVariableName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
