...
public final class pushAuth_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("org.wso2.carbon.identity.local.auth.push.authenticator.util.AuthenticatorUtils");
 ...
 request.setAttribute("pageName", "push-auth"); 
      ...
      out.write("    </head>\n");
      out.write("\n");
      out.write("    <body class=\"login-portal layout push-auth-portal-layout\" data-page=\"");
 ...
 if (new File(getServletContext().getRealPath("extensions/timeout.jsp")).exists()) { 
      ...
      try {
        ...
        // /pushAuth.jsp(123,8) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /pushAuth.jsp(123,8) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /pushAuth.jsp(123,8) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /pushAuth.jsp(125,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /pushAuth.jsp(137,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("                    <h2>\n");
                  out.write("                        ");
                  out.print( i18n(resourceBundle, customText, "push.auth.heading") );
                  out.write("\n");
                  out.write("                    </h2>\n");
                  ...
                  out.write("                        <form class=\"ui large form\" id=\"submitForm\" name=\"submitForm\" action=\"");
                  ...
                  out.write("                            ");
                  out.write("\n");
                  out.write("                            <div id=\"pollingResponse\"></div>\n");
                  out.write("\n");
                  out.write("                            ");
                  out.write("\n");
                  out.write("                            <div class=\"field\">\n");
                  out.write("                                <div id='responseReceived' class='ui green icon message transition hidden'>\n");
                  out.write("                                    <div style=\"width: 30%; padding-left: 25px\">\n");
                  out.write("                                        <i class='big green check circle outline icon'></i>\n");
                  out.write("                                    </div>\n");
                  out.write("                                    <div style=\"width: 70%\">\n");
                  out.write("                                        <p>");
                  out.print( mobileResponseReceived );
                  out.write("</p>\n");
                  out.write("                                    </div>\n");
                  out.write("                                </div>\n");
                  out.write("                                <div id='noResponseMessage' class='ui negative message transition hidden' style='text-align: center;'>");
                  out.print( noAuthResponseMessage );
                  out.write("</div>\n");
                  out.write("                                <div id=\"instruction-div\">\n");
                  out.write("                                    ");
                  ...
                  out.write("                                        ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "push.notification.sent.msg.with.challenge"));
                  out.write("\n");
                  out.write("                                    </p>\n");
                  out.write("                                    <h3 class=\"text-center\">\n");
                  out.write("                                        ");
                  out.print( Encode.forHtmlContent(numberChallengeValue) );
                  out.write("\n");
                  out.write("                                    </h3>\n");
                  out.write("                                    ");
 } else { 
                  ...
                  out.write("                                    <p class=\"text-center\">\n");
                  out.write("                                        ");
                  out.print(i18n(resourceBundle, customText, "push.notification.sent.msg"));
                  out.write("\n");
                  out.write("                                    </p>\n");
                  out.write("                                    ");
 } 
                  ...
                  out.write("' />\n");
                  out.write("                            <input type='hidden' name='scenario' id='scenario' value=''/>\n");
                  out.write("\n");
                  out.write("                            <div class=\"buttons\">\n");
                  out.write("                                <button type=\"button\"\n");
                  out.write("                                        class=\"ui fluid large button primary mt-2\"\n");
                  out.write("                                        id=\"resend\">\n");
                  out.write("                                    ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "resend.push.notification"));
                  out.write("\n");
                  out.write("                                </button>\n");
                  out.write("\n");
                  out.write("                                ");
            ...
            try {
              ...
              // /pushAuth.jsp(238,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("                    document.getElementById(\"scenario\").value = \"RESEND_PUSH_NOTIFICATION\";\n");
      out.write("                    $(\"#submitForm\").submit();\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("\n");
      out.write("            $(document).ready(handleWaitBeforeResendNotification);\n");
      out.write("\n");
      out.write("            function handleWaitBeforeResendNotification() {\n");
      out.write("                // value should be less than 3600\n");
      out.write("                const WAIT_TIME_SECONDS = ");
      out.print( enableResendTime );
      out.write(";\n");
      out.write("\n");
      ...
      out.write("                        // Stop polling when the countdown ends.\n");
      out.write("                        stopPolling();\n");
      out.write("                        document.getElementById(\"instruction-div\").style.display = \"none\";\n");
      out.write("                        $(\"#noResponseMessage\").transition(\"fade\");\n");
      out.write("                    },\n");
      out.write("                    (time) => {\n");
      out.write("                        resendButton.innerHTML = time.minutes.toString().padStart(2, '0') + \" : \" + time.seconds.toString().padStart(2, '0');\n");
      out.write("                    },\n");
      out.write("                    \"PUSH_NOTIFICATION_TIMER\"\n");
      out.write("                ).start();\n");
      out.write("\n");
      ...
      out.write("                // Poll every 5 seconds\n");
      out.write("\n");
      out.write("                const POLL_INTERVAL_MS = 5000;\n");
      out.write("\n");
      out.write("                const urlParams = new URLSearchParams(window.location.search);\n");
      out.write("                var pushAuthId = null;\n");
      out.write("                if (urlParams.has('pushAuthId')) {\n");
      out.write("                    pushAuthId = encodeURIComponent(urlParams.get('pushAuthId'));\n");
      out.write("                }\n");
      out.write("\n");
      out.write("                const STATUS_URL = \"/push-auth/check-status?pushAuthId=\"+pushAuthId;\n");
      out.write("\n");
      out.write("                pollingInterval = setInterval(() => {\n");
      out.write("                    $.ajax({\n");
      out.write("                        url: \"");
      out.print( Encode.forJavaScriptBlock(identityServerEndpointContextParam));
      out.write("\" + STATUS_URL,\n");
      out.write("                        type: \"GET\",\n");
      out.write("                        contentType: \"application/json\",\n");
      out.write("                        success: function (response) {\n");
      out.write("                            if (response.status === \"COMPLETED\") {\n");
      out.write("                                clearInterval(pollingInterval);\n");
      out.write("                                setTimeout(() => {\n");
      out.write("                                    document.getElementById(\"scenario\").value = \"PROCEED_PUSH_AUTHENTICATION\";\n");
      out.write("                                    $(\"#submitForm\").submit();\n");
      out.write("                                }, 2500);\n");
      out.write("                            }\n");
      out.write("                        },\n");
      out.write("                        error: function (xhr, status, error) {\n");
      out.write("                            console.error(\"Error occurred while polling for push notification status: \" + error);\n");
      out.write("                        }\n");
      out.write("                    });\n");
      out.write("                }, POLL_INTERVAL_MS);\n");
      out.write("            }\n");
      out.write("\n");
  ...
  private boolean _jspx_meth_layout_005fdynamicComponent_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_layout_005fmain_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /pushAuth.jsp(250,12) name = filePathStoringVariableName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
