...
public final class pushDeviceEnrollConsent_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (new File(getServletContext().getRealPath("extensions/timeout.jsp")).exists()) { 
      ...
      try {
        ...
        // /pushDeviceEnrollConsent.jsp(93,8) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /pushDeviceEnrollConsent.jsp(93,8) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /pushDeviceEnrollConsent.jsp(93,8) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /pushDeviceEnrollConsent.jsp(94,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /pushDeviceEnrollConsent.jsp(106,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("                    <h2>\n");
                  out.write("                       ");
                  out.print( i18n(resourceBundle, customText, "push.device.not.registered") );
                  out.write("\n");
                  out.write("                    </h2>\n");
                  out.write("                    <div class=\"ui divider hidden\"></div>\n");
                  out.write("                    <div class=\"segment-form\">\n");
                  out.write("                        <form class=\"ui large form\" id=\"form\" name=\"form\" action=\"");
                  out.print(commonauthURL);
                  out.write("\" method=\"POST\">\n");
                  out.write("                            <div class=\"field\">\n");
                  out.write("                                <p class=\"text-center\">\n");
                  out.write("                                    ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "push.device.not.found.description"));
                  out.write("\n");
                  out.write("                                </p>\n");
                  out.write("                            </div>\n");
                  out.write("\n");
                  ...
                  out.write("                                    ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "push.register.button"));
                  out.write("\n");
                  out.write("                                </button>\n");
                  out.write("                                <button type=\"button\"\n");
                  ...
                  out.write("                                        id=\"cancel\">\n");
                  out.write("                                    ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "push.register.cancel"));
                  out.write("\n");
                  out.write("                                </button>\n");
                  out.write("                                ");
            ...
            try {
              ...
              // /pushDeviceEnrollConsent.jsp(161,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("                    document.getElementById(\"scenario\").value = \"INIT_PUSH_ENROLL\";\n");
      ...
      out.write("                    document.getElementById(\"scenario\").value = \"CANCEL_PUSH_ENROLL\";\n");
      out.write("                    $('#form').submit();\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("        </script>\n");
  ...
  private boolean _jspx_meth_layout_005fdynamicComponent_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_layout_005fmain_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /pushDeviceEnrollConsent.jsp(172,12) name = filePathStoringVariableName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
