...
public final class mobile_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 request.setAttribute("pageName", "mobile"); 
      ...
      out.write("    </head>\n");
      out.write("\n");
      out.write("    <body class=\"login-portal layout sms-otp-portal-layout\" onload=\"getLoginDiv()\" data-page=\"");
      ...
      try {
        ...
        // /mobile.jsp(100,8) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /mobile.jsp(100,8) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /mobile.jsp(100,8) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /mobile.jsp(101,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /mobile.jsp(112,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("\n");
                  out.write("                    <h2>");
                  out.print(IdentityManagementEndpointUtil.i18n(resourceBundle, "enter.phone.number"));
                  out.write("</h2>\n");
                  ...
                  out.write("\n");
                  out.write("                    <div id=\"error-msg\"></div>\n");
                  ...
                  out.print(IdentityManagementEndpointUtil.i18n(resourceBundle, "error.retry"));
                  out.write("</div>\n");
                  out.write("                                        <div class=\"ui divider hidden\"></div>\n");
                  out.write("                            ");
 } }  
                  ...
                  out.write("                                <label class=\"control-label\" for=\"password\"></label>\n");
                  out.write("                                <input type=\"text\" id='MOBILE_NUMBER' name=\"MOBILE_NUMBER\"\n");
                  out.write("                                        class=\"input-xlarge\" size='30'/>\n");
                  out.write("                            </div>\n");
                  ...
                  out.write("                                <input type=\"button\" name=\"update\" id=\"update\" value=\"");
                  out.print(IdentityManagementEndpointUtil.i18n(resourceBundle, "update"));
                  out.write("\"\n");
            ...
            try {
              ...
              // /mobile.jsp(164,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("\n");
      out.write("\n");
      out.write("        <div id=\"regexData\" data-regex=\"");
      out.print(Encode.forHtmlAttribute(mobileRegex));
      out.write("\" style=\"display:none;\"></div>\n");
      out.write("\n");
      out.write("        <script type=\"text/javascript\">\n");
      out.write("            $(document).ready(function() {\n");
      out.write("                $('#update').click(function() {\n");
      out.write("                    var mobileNumber = document.getElementById(\"MOBILE_NUMBER\").value;\n");
      out.write("                    var regexPattern = document.getElementById('regexData').dataset.regex;\n");
      out.write("                    // decode HTML-encoded backslashes for use in RegExp constructor\n");
      out.write("                    regexPattern = regexPattern.replace(/\\\\\\\\/g, \"\\\\\");\n");
      out.write("                    var regexObj = new RegExp(regexPattern);\n");
      out.write("                    if (mobileNumber == \"\") {\n");
      out.write("                        document.getElementById('alertDiv').innerHTML\n");
      out.write("                            = '<div id=\"error-msg\" class=\"ui negative message\">");
      out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "please.enter.mobile.number"));
      out.write("</div>'\n");
      out.write("                              +'<div class=\"ui divider hidden\"></div>';\n");
      out.write("                    } else if (");
      out.print(validateMobileNumberFormat);
      out.write(" && !(regexObj.test(mobileNumber))) {\n");
      out.write("                       document.getElementById('alertDiv').innerHTML\n");
      out.write("                          = '<div id=\"error-msg\" class=\"ui negative message\">");
      out.print(Encode.forHtml(mobileRegexPolicyValidationErrorMessage));
      out.write("</div>'\n");
      out.write("                            +'<div class=\"ui divider hidden\"></div>';\n");
      out.write("                    } else {\n");
      out.write("                        $('#pin_form').submit();\n");
      out.write("                    }\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("        </script>\n");
  ...
  private boolean _jspx_meth_layout_005fdynamicComponent_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_layout_005fmain_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /mobile.jsp(175,12) name = filePathStoringVariableName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
