...
import org.wso2.carbon.identity.application.authentication.framework.handler.request.impl.consent.PolicyConsentUtil;
import org.wso2.carbon.identity.application.authentication.endpoint.util.AuthenticationEndpointUtil;
...
public final class policy_005fconsent_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("org.wso2.carbon.identity.application.authentication.framework.handler.request.impl.consent.PolicyConsentUtil");
 ...
 if (new File(getServletContext().getRealPath("extensions/timeout.jsp")).exists()) { 
      ...
      try {
        ...
        // /policy_consent.jsp(155,4) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /policy_consent.jsp(155,4) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /policy_consent.jsp(155,4) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /policy_consent.jsp(156,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /policy_consent.jsp(167,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("\" method=\"post\" id=\"policy-consent-form\">\n");
                  out.write("                    <div class=\"field light-font\">\n");
                  out.write("                        <div>\n");
                  out.write("                            <h4>\n");
                  out.write("                                ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "policy.consent.title"));
                  out.write("\n");
                  out.write("                            </h4>\n");
                  out.write("                        </div>\n");
                  out.write("                    </div>\n");
                  ...
                  out.write("                        ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "policy.consent.description"));
                  out.write("\n");
                  out.write("                    </p>\n");
                  out.write("\n");
 ...
 if (mandatoryPurposeIds.length > 0 || optionalPurposeIds.length > 0) { 
                  ...
                  out.write("                                    <i aria-hidden=\"true\" class=\"circle tiny icon primary consent-item-bullet\" id=\"new_policies_section_icon\"></i>\n");
                  out.write("                                    <div class=\"content\">\n");
                  out.write("                                        <div class=\"header light-font consentItem\">\n");
                  out.write("                                            ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "policy.consent.section.new.title"));
                  out.write("\n");
                  out.write("                                        </div>\n");
                  out.write("                                    </div>\n");
                  out.write("                                    <div class=\"content light-font\">\n");
                  out.write("                                        <div class=\"border-gray margin-bottom-double\">\n");
                  out.write("                                            <div class=\"mt-3 mb-3 claim-list\">\n");
                  out.write("                                                ");
 for (String purposeId : mandatoryPurposeIds) {
                  ...
                  out.write("\n");
                  out.write("                                                <div class=\"mt-1 pl-5 required mandatoryClaim\" title=\"");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "policy.consent.mandatory"));
                  out.write("\">\n");
                  out.write("                                                    <div class=\"ui checkbox claim-cb\">\n");
                  out.write("                                                        <input type=\"checkbox\" class=\"mandatory-consent hidden\" name=\"mandatoryPurposeId\"\n");
                  out.write("                                                            value=\"");
                  out.print(Encode.forHtmlAttribute(trimmedId));
                  out.write("\"\n");
                  out.write("                                                            id=\"mandatory-");
                  out.print(Encode.forHtmlAttribute(trimmedId));
                  out.write("\"/>\n");
                  out.write("                                                        <label for=\"mandatory-");
                  out.print(Encode.forHtmlAttribute(trimmedId));
                  out.write("\">\n");
                  out.write("                                                            ");
                  out.print(label);
                  out.write(" <b class=\"login-portal-app-font\">*</b>\n");
                  out.write("                                                        </label>\n");
                  out.write("                                                    </div>\n");
                  out.write("                                                </div>\n");
                  out.write("                                                ");
 ...
 for (String purposeId : optionalPurposeIds) {
                  ...
                  out.write("                                                    <div class=\"ui checkbox claim-cb\">\n");
                  out.write("                                                        <input type=\"checkbox\" class=\"hidden\" name=\"optionalPurposeId\"\n");
                  out.write("                                                            value=\"");
                  out.print(Encode.forHtmlAttribute(trimmedId));
                  out.write("\"\n");
 ...
 if (mandatoryNewVersionIds.length > 0 || optionalNewVersionIds.length > 0) { 
                  out.write("\n");
                  out.write("                                <div class=\"item\">\n");
                  out.write("                                    <i aria-hidden=\"true\" class=\"circle tiny icon primary consent-item-bullet\" id=\"updated_policies_section_icon\"></i>\n");
                  out.write("                                    <div class=\"content\">\n");
                  out.write("                                        <div class=\"header light-font consentItem\">\n");
                  out.write("                                            ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "policy.consent.section.updated.title"));
                  out.write("\n");
                  out.write("                                        </div>\n");
                  out.write("                                    </div>\n");
                  out.write("                                    <div class=\"content light-font\">\n");
 ...
 if (spId != null && !spId.trim().isEmpty()) { 
                  ...
                  out.print(Encode.forHtmlAttribute(spId.trim()));
                  out.write("\"/>\n");
                  out.write("                        ");
 } 
                  out.write("\n");
 ...
 for (String hiddenId : allMandatoryIds) { 
                  out.write("\n");
                  out.write("                        <input type=\"hidden\" name=\"policyMandatoryIds\"\n");
                  out.write("                               value=\"");
                  out.print(Encode.forHtmlAttribute(hiddenId));
                  out.write("\"/>\n");
                  out.write("                        ");
 } 
                  out.write("\n");
 ...
 for (String hiddenId : allOptionalIds) { 
                  out.write("\n");
                  out.write("                        <input type=\"hidden\" name=\"policyOptionalIds\"\n");
                  out.write("                               value=\"");
                  out.print(Encode.forHtmlAttribute(hiddenId));
                  out.write("\"/>\n");
                  out.write("                        ");
                  ...
                  out.write("                            <input type=\"button\" class=\"ui primary fluid large button\" id=\"approve\"\n");
            ...
            try {
              ...
              // /policy_consent.jsp(322,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("\n");
      out.write("    <script type=\"text/javascript\">\n");
      out.write("        function updateApproveButton() {\n");
      out.write("            var unchecked = document.querySelectorAll(\"input.mandatory-consent:not(:checked)\");\n");
      out.write("            document.getElementById(\"approve\").disabled = unchecked.length > 0;\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        function approved() {\n");
      out.write("            var unchecked = document.querySelectorAll(\"input.mandatory-consent:not(:checked)\");\n");
      out.write("            if (unchecked.length > 0) {\n");
      out.write("                unchecked[0].focus();\n");
      out.write("                return false;\n");
      out.write("            }\n");
      out.write("            document.getElementById('consent').value = \"approve\";\n");
      out.write("            document.getElementById(\"policy-consent-form\").submit();\n");
      out.write("        }\n");
      out.write("\n");
      ...
      out.write("            updateApproveButton();\n");
      out.write("            document.querySelectorAll(\"input.mandatory-consent\").forEach(function(cb) {\n");
      out.write("                cb.addEventListener(\"change\", updateApproveButton);\n");
      out.write("            });\n");
      out.write("        });\n");
      out.write("    </script>\n");
      out.write("</body>\n");
  ...
  private boolean _jspx_meth_layout_005fdynamicComponent_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_layout_005fmain_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /policy_consent.jsp(333,8) name = filePathStoringVariableName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
