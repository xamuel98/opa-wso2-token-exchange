...
public final class backup_002dcode_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("org.wso2.carbon.identity.application.authenticator.backupcode.constants.BackupCodeAuthenticatorConstants");
 ...
 request.setAttribute("pageName","backup-code"); 
      ...
      out.write("\n");
      out.write("        <script>\n");
      out.write("            var isBackupCodeSubmitting = false;\n");
      out.write("\n");
      out.write("            // Handle form submission via a single guarded path.\n");
      out.write("            $(document).ready(function(){\n");
      out.write("                $('#backupCodeForm').on('submit', function (e) {\n");
      ...
      out.write("                var backupCodeText = '");
      out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "enter.backup.code"));
      out.write("';\n");
      out.write("                var text = backupCodeText\n");
      ...
      out.write("    </head>\n");
      out.write("\n");
      out.write("    <body class=\"login-portal layout backup-code-portal-layout\" data-page=\"");
 ...
 if (new File(getServletContext().getRealPath("extensions/timeout.jsp")).exists()) { 
      ...
      try {
        ...
        // /backup-code.jsp(133,8) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /backup-code.jsp(133,8) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /backup-code.jsp(133,8) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /backup-code.jsp(134,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /backup-code.jsp(145,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("                        ");
                  out.print(AuthenticationEndpointUtil.i18n(resourceBundle, "backup.code.heading"));
                  out.write("\n");
                  out.write("                    </h3>\n");
                  out.write("\n");
                  out.write("                    ");
                  ...
                  out.write("\" method=\"post\" id=\"backupCodeForm\" class=\"ui large form otp-form\">\n");
                  out.write("                            <p class=\"text-center\" id=\"instruction\"></p>\n");
                  out.write("                            <div class=\"field\">\n");
                  out.write("                                <input hidden type=\"text\"  id=\"BackupCode\" name=\"BackupCode\" class=\"form-control\">\n");
                  out.write("                            </div>\n");
                  out.write("\n");
 ...
 String multiOptionURI = request.getParameter("multiOptionURI");
                  ...
                  out.print(Encode.forJavaScript(multiOptionURI));
                  out.write("';\"\n");
            ...
            try {
              ...
              // /backup-code.jsp(271,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("                if (isBackupCodeSubmitting) {\n");
      out.write("                    return false;\n");
      out.write("                }\n");
      out.write("\n");
      ...
      out.write("                value = clipboardData.getData('Text');\n");
      out.write("                const reg = new RegExp(/^\\d+$/);\n");
      out.write("                if (reg.test(value)) {\n");
      out.write("                    for (n = 0; n < 6; ++n) {\n");
      out.write("                        $(\"#pincode-\" + (n+1)).val(value[n]);\n");
      out.write("                        $(\"#pincode-\" + (n+1)).focus();\n");
      out.write("                    }\n");
      out.write("                }\n");
      out.write("            }\n");
      out.write("            document.getElementById('pincode-1').addEventListener('paste', handlePaste);\n");
      out.write("            $('#subButton').attr('disabled', true);\n");
  ...
  private boolean _jspx_meth_layout_005fdynamicComponent_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_layout_005fmain_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /backup-code.jsp(282,12) name = filePathStoringVariableName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
