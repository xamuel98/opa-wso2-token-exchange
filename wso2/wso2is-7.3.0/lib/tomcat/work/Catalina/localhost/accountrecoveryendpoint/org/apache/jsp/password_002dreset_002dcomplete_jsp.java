...
public final class password_002dreset_002dcomplete_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    */
    ...
    public static void addNetworkRequestHeaders(Map<String, String> requestHeaders, HttpServletRequest request) {
        
        // Add client IP to the request headers.
        String clientIp = IdentityUtil.getClientIpAddress(request);
        if (StringUtils.isNotBlank(clientIp)) {
            requestHeaders.put("X-Forwarded-For", clientIp);
        }

        // Add user agent to the request headers.
        String userAgent = request.getHeader("User-Agent");
        if (StringUtils.isNotBlank(userAgent)) {
            requestHeaders.put("X-Forwarded-User-Agent", userAgent);
        }
    }
  ...
  static {
    ...
    _jspx_dependants.put("/request-header-resolver.jsp", Long.valueOf(1776610170000L));
  ...
  static {
    ...
    _jspx_imports_classes = new java.util.LinkedHashSet<>(64);
    ...
    _jspx_imports_classes.add("org.wso2.carbon.identity.mgt.endpoint.util.client.model.recovery.v2.ResetRequest");
    _jspx_imports_classes.add("org.wso2.carbon.identity.mgt.endpoint.util.client.model.recovery.v2.ResetResponse");
 ...
 request.setAttribute("pageName", "password-reset-complete"); 
    ...
    layoutData.put("isPasswordResetCompletePage", true);
      ...
      try {
        ...
        // /password-reset-complete.jsp(386,4) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /password-reset-complete.jsp(386,4) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /password-reset-complete.jsp(386,4) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /password-reset-complete.jsp(387,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /password-reset-complete.jsp(398,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("                <h3 class=\"ui header text-center slogan-message mt-4 mb-6\" data-testid=\"password-reset-complete-page-header\">\n");
                  out.write("                    ");
 if (RECOVERY_TYPE_INVITE.equalsIgnoreCase(type)) { 
                  out.write("\n");
                  out.write("                        ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,"Password.set.success"));
                  out.write("\n");
                  out.write("                    ");
 } else { 
                  out.write("\n");
                  out.write("                        ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,"Password.reset.Success"));
                  out.write("\n");
                  out.write("                    ");
 } 
                  out.write("\n");
 ...
 if (RECOVERY_TYPE_INVITE.equalsIgnoreCase(type)) { 
                  out.write("\n");
                  out.write("                        ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "successfully.set.a.password"));
                  out.write(".\n");
                  out.write("                        <br/>\n");
                  out.write("                        <br/>\n");
                  out.write("                        ");
 ...
 if (StringUtils.isNotBlank(applicationName) && applicationName.equals(MY_ACCOUNT_APP_NAME)) {
                  out.write("\n");
                  out.write("                                ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "manage.profile.via"));
                  out.write("\n");
                  out.write("                                <a href=\"");
                  out.print(IdentityManagementEndpointUtil.getURLEncodedCallback(
                                    applicationAccessURLWithoutEncoding));
                  out.write('"');
                  out.write('>');
                  out.print(MY_ACCOUNT_APP_NAME);
                  out.write("</a>.\n");
                  out.write("                            ");
 } else { 
                  out.write("\n");
                  out.write("                                ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "can.sign.in.to"));
                  out.write("\n");
                  out.write("                                <a href=\"");
                  out.print(IdentityManagementEndpointUtil.getURLEncodedCallback(
                                    applicationAccessURLWithoutEncoding));
                  ...
                  out.write("\n");
                  out.write("                        ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "successfully.set.a.password.you.can.sign.in.now"));
                  out.write(".\n");
                  out.write("                    ");
 } 
                  out.write("\n");
 ...
 if (StringUtils.isNotBlank(userStoreDomain)) {
            ...
            try {
              ...
              // /password-reset-complete.jsp(457,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_layout_005fdynamicComponent_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_layout_005fmain_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /password-reset-complete.jsp(468,8) name = filePathStoringVariableName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
