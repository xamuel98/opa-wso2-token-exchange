...
public final class self_002dregistration_002dcomplete_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes = new java.util.LinkedHashSet<>(74);
 ...
 if (isDetailedResponseEnabled && StringUtils.isNotBlank(userId)) { 
      ...
      out.print( Encode.forHtmlAttribute(userId) );
      out.write("\" />\n");
 } 
      out.write('\n');
      out.write('\n');
 request.setAttribute("pageName", "self-registration-complete"); 
    ...
    layoutData.put("isSelfRegistrationCompletePage", true);
      ...
      out.write("\n");
      out.write("</head>\n");
      out.write("<body class=\"login-portal layout\" data-response-type=\"success\" data-page=\"");
      out.print( request.getAttribute("pageName") );
      out.write("\">\n");
      out.write("    <script>\n");
      out.write("        function redirect(redirectURL) {\n");
      out.write("            var url = redirectURL;\n");
      out.write("            window.location.href = url;\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        // Mask Email\n");
      out.write("        function maskEmail(email) {\n");
      out.write("            email = email.split('');\n");
      out.write("            let finalArr=[];\n");
      out.write("            let len = email.indexOf('@');\n");
      out.write("            email.forEach((item,pos)=> {\n");
      out.write("                (pos>=1 && pos<=len-2) ? finalArr.push('*') : finalArr.push(email[pos]);\n");
      out.write("            })\n");
      out.write("            document.getElementById(\"maskedEmail\").innerHTML = finalArr.join('');\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        // UI countdown\n");
      out.write("        function countdown(redirectURL) {\n");
      out.write("            var timeleft = 3;\n");
      ...
      out.write("                    redirect(redirectURL);\n");
      out.write("                } else {\n");
      ...
      try {
        ...
        // /self-registration-complete.jsp(288,8) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /self-registration-complete.jsp(288,8) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /self-registration-complete.jsp(288,8) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /self-registration-complete.jsp(289,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /self-registration-complete.jsp(300,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\n");
                  out.write("                <div class=\"ui green segment mt-3 attached\">\n");
                  out.write("                        <h3 class=\"ui header text-center slogan-message mt-4 mb-6\" data-testid=\"self-register-complete-page-header\">\n");
                  out.write("                            ");
 if (isPendingApproval) { 
                  out.write("\n");
                  out.write("                            ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "registration.submitted"));
                  out.write("\n");
                  out.write("                            ");
 } else if (StringUtils.isNotBlank(confirm)) { 
                  out.write("\n");
                  out.write("                            ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "account.verified.successfully"));
                  out.write("\n");
                  out.write("                            ");
 } else if (accountLockOnCreationEnabled) { 
                  out.write("\n");
                  out.write("                            ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "you.are.almost.there"));
                  out.write("\n");
                  out.write("                            ");
 } else {
                  out.write("\n");
                  out.write("                            ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "account.created.successfully"));
                  out.write("\n");
                  out.write("                            ");
 } 
                  out.write("\n");
                  out.write("                        </h3>\n");
                  out.write("\n");
                  out.write("                        <p class=\"portal-tagline-description\">\n");
                  out.write("                            ");
                  ...
                  out.write("\n");
                  out.write("                                ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "pending.account.approval"));
                  out.write("\n");
                  out.write("                            ");
 } else if (StringUtils.isNotBlank(confirm)) { 
                  out.write("\n");
                  out.write("                                ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "your.account.with.username"));
                  out.write("\n");
                  out.write("                                <b>");
                  out.print(Encode.forHtml(resendUsername));
                  out.write("</b>\n");
                  out.write("                                ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "has.been.verified.successfully"));
                  out.write("\n");
                  out.write("                            ");
                  ...
                  out.write("\n");
                  out.write("                                <script>countdown('");
                  out.print( url );
                  out.write("');</script>\n");
                  out.write("                                <br/><br/>\n");
                  out.write("                                ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "you.will.redirected.back.to.the.application.in"));
                  out.write("\n");
                  out.write("                                <span id=\"countdown\" class=\"text-typography primary\">3</span> ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "seconds"));
                  out.write("\n");
                  out.write("                                <br/><br/>\n");
                  out.write("\n");
                  out.write("                            ");
                  ...
                  out.write("                                <br/><br/>\n");
                  out.write("                                ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "you.can.now.sign.in.to.account"));
                  out.write("\n");
                  out.write("                                <br/><br/>\n");
                  out.write("                            ");
                  ...
                  out.write("\n");
                  out.write("                                ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "check.your.inbox.at"));
                  out.write("\n");
                  out.write("                                <b><span id=\"maskedEmail\"></span></b> ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "for.instructions.to.activate.your.account"));
                  out.write("\n");
                  out.write("                                <script>\n");
                  out.write("                                    ");
 if (StringUtils.isNotBlank(emailValue)) { 
                  out.write("\n");
                  out.write("                                        maskEmail('");
                  out.print( Encode.forJavaScript(emailValue) );
                  out.write("');\n");
                  out.write("                                    ");
 } 
                  out.write("\n");
                  ...
                  out.write("\n");
                  out.write("                                <i class=\"caret left icon primary\"></i>\n");
                  out.write("                                <a href=\"");
                  out.print( IdentityManagementEndpointUtil.getURLEncodedCallback(tenantedMyaccountURL));
                  out.write("\">\n");
                  out.write("                                    ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,"Go.to.MyAccount"));
                  out.write("\n");
                  out.write("                                </a>\n");
                  out.write("                            ");
                  ...
                  out.write("                                <i class=\"caret left icon primary\"></i>\n");
                  out.write("                                <a href=\"");
                  out.print( IdentityManagementEndpointUtil.getURLEncodedCallback(applicationAccessURLWithoutEncoding));
                  out.write("\">\n");
                  out.write("                                    ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,"Back.to.application"));
                  out.write("\n");
                  out.write("                                </a>\n");
                  out.write("                            ");
                  ...
                  out.write(" <b><span id=\"maskedEmail\"></span></b>\n");
                  out.write("                                ");
                  out.print(IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "several.functionalities.will.not.available.until.confirmation"));
                  out.write("\n");
                  out.write("                                <br/><br/>\n");
                  out.write("                            ");
            ...
            try {
              ...
              // /self-registration-complete.jsp(441,12) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_layout_005fdynamicComponent_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_layout_005fmain_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /self-registration-complete.jsp(452,12) name = filePathStoringVariableName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
