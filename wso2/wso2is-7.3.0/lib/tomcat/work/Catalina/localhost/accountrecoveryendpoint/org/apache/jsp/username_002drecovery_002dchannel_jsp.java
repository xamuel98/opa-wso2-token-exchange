...
import org.wso2.carbon.identity.mgt.endpoint.util.client.model.recovery.v2.*;
...
public final class username_002drecovery_002dchannel_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_packages.add("org.wso2.carbon.identity.mgt.endpoint.util.client.model.recovery.v2");
    _jspx_imports_packages.add("java.util");
    _jspx_imports_classes = new java.util.LinkedHashSet<>(44);
 ...
 request.setAttribute("pageName", "username-recovery-channel"); 
      ...
      try {
        ...
        // /username-recovery-channel.jsp(159,4) name = layoutName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutName( layout );
        // /username-recovery-channel.jsp(159,4) name = layoutFileRelativePath type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_layout_005fmain_005f0.setLayoutFileRelativePath( layoutFileRelativePath );
        // /username-recovery-channel.jsp(159,4) name = data type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_layout_005fmain_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /username-recovery-channel.jsp(160,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            try {
              ...
              // /username-recovery-channel.jsp(171,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_layout_005fcomponent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("                <h2>");
                  out.print(i18n(recoveryResourceBundle, customText, "username.recovery.channel.selection.heading"));
                  out.write("</h2>\n");
                  out.write("                ");
 if (error) { 
                  out.write("\n");
                  ...
                  out.write("\n");
                  out.write("                ");
                  out.print(i18n(recoveryResourceBundle, customText, "username.recovery.channel.selection.body"));
                  out.write("\n");
                  out.write("\n");
                  out.write("                <div class=\"ui divider hidden\"></div>\n");
                  out.write("\n");
                  out.write("                <div class=\"segment-form\">\n");
                  out.write("                    <form class=\"ui large form\" method=\"post\" action=\"verify.do\" id=\"channelSelectionForm\">\n");
                  out.write("                        ");
                  ...
                  out.write("                                    <input type=\"radio\" name=\"usernameRecoveryOption\"\n");
                  out.write("                                        value=\"");
                  out.print(Encode.forHtmlAttribute(getChannelIdFromChannelName(channels, EMAIL) + ":" + EMAIL));
                  out.write("\"\n");
                  out.write("                                        ");
                  out.print(EMAIL.equals(selectedOption)?"checked":"");
                  out.write("/>\n");
                  out.write("                                    <label>");
                  out.print(i18n(recoveryResourceBundle, customText, "send.username.via.email"));
                  out.write("\n");
                  out.write("                                    </label>\n");
                  out.write("                                </div>\n");
                  out.write("                            </div>\n");
                  ...
                  out.write("                                    <input type=\"radio\" name=\"usernameRecoveryOption\"\n");
                  out.write("                                        value=\"");
                  out.print(Encode.forHtmlAttribute(getChannelIdFromChannelName(channels, SMS) + ":" + SMS));
                  out.write("\"\n");
                  out.write("                                        ");
                  out.print(SMS.equals(selectedOption)?"checked":"");
                  out.write("/>\n");
                  out.write("                                    <label>");
                  out.print(i18n(recoveryResourceBundle, customText, "send.username.via.sms"));
                  out.write("\n");
                  out.write("                                    </label>\n");
                  out.write("                                </div>\n");
                  out.write("                            </div>\n");
                  ...
                  out.write("                        <input type=\"hidden\" id=\"recoveryStage\" name=\"recoveryStage\" value=\"NOTIFY\">\n");
                  out.write("                        <input type=\"hidden\" id=\"isUserFound\" name=\"isUserFound\" value=");
                  out.print(isUserFound);
                  out.write(">\n");
                  out.write("                        <input type=\"hidden\" id=\"recoveryCode\" name=\"recoveryCode\" value=");
                  out.print(recoveryCode);
                  out.write(">\n");
                  out.write("\n");
                  out.write("                        <div class=\"ui divider hidden\"></div>\n");
                  ...
                  out.write("                                    ");
                  out.print(i18n(recoveryResourceBundle, customText, "username.recovery.channel.selection.next.button"));
                  out.write("\n");
                  out.write("                            </button>\n");
                  out.write("                        </div>\n");
                  ...
                  out.write("                                ");
                  out.print(i18n(recoveryResourceBundle, customText, "username.recovery.channel.selection.cancel.button"));
                  out.write("\n");
                  out.write("                            </a>\n");
                  out.write("                        </div>\n");
                  out.write("                    </form>\n");
            ...
            try {
              ...
              // /username-recovery-channel.jsp(249,8) name = componentName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("            $(\"#channelSelectionForm\").submit();\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        $(document).ready(function () {\n");
      out.write("            $(\"#channelSelectionForm\").submit(function (e) {\n");
      out.write("\n");
  ...
  private boolean _jspx_meth_layout_005fdynamicComponent_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_layout_005fmain_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /username-recovery-channel.jsp(260,8) name = filePathStoringVariableName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
